...
#ifndef CustomOsiGlpkSolverInterface_H
#define CustomOsiGlpkSolverInterface_H
...
/** GPLK Solver Interface
    ...
    Instantiation of CustomOsiGlpkSolverInterface for GPLK
*/
...
#endif
const double GLP_ZERO_TOL = 1.0e-9 ;

class CustomOsiGlpkSolverInterface : virtual public OsiSolverInterface {
...
public:
  ...
  */
  ...
  LPX * getModelPtr();
  /// Get pointer to the parameters
  glp_iocp * getEnvPtr() const;
  ...
  */
  ...
  //@{
  /// Default Constructor
  CustomOsiGlpkSolverInterface(); 
  
  /// Clone
  virtual OsiSolverInterface * clone(bool copyData = true) const;
  
  /// Copy constructor 
  CustomOsiGlpkSolverInterface( const CustomOsiGlpkSolverInterface& );
  
  /// Assignment operator 
  CustomOsiGlpkSolverInterface& operator=( const CustomOsiGlpkSolverInterface& rhs );
  
  /// Destructor 
  virtual ~CustomOsiGlpkSolverInterface();
...
private: 
  ...
  void gutsOfCopy( const CustomOsiGlpkSolverInterface & source );
  ...
  ///GLPK control parameter structure
  mutable glp_iocp parm_;
...
void CustomOsiGlpkSolverInterfaceUnitTest(const std::string & mpsDir, const std::string & netlibDir);

#endif // CustomOsiGlpkSolverInterface_H
